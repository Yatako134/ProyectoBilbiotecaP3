...
private ResultSet rs;
    ...
    public int insertar(Ejemplar objeto) {
        ...
        parametrosEntrada.put(3, objeto.getEstado().name());
        parametrosEntrada.put(4, objeto.getUbicacion());
        parametrosEntrada.put(5, objeto.isActivo());
        parametrosEntrada.put(6, objeto.getBlibioteca().getIdBiblioteca());
