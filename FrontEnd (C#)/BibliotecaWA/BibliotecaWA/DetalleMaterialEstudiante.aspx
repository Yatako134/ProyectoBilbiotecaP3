<%@ Page Title="" Language="C#" MasterPageFile="~/HomeEstudiante.Master" AutoEventWireup="true" CodeBehind="DetalleMaterialEstudiante.aspx.cs" Inherits="BibliotecaWA.DetalleMaterialEstudiante" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    ...
    <div class="me-3"> <p1>Búsqueda</p1> </div>
    <i class="fa-solid fa-greater-than me-3 fa-xs"></i>
    <p1 class="fw-bold">Detalle del material</p1>
</div>
                                    ...
                                    <ItemTemplate>
                                        <div class="border rounded p-2 mb-2">
                                            ...
                                            <div>
                                               ...
                                               <span class='<%# ((BibliotecaWA.DetalleMaterialEstudiante)Page).GetEstadoCss(Eval("estado").ToString()) %>'>
                                                   <%# Eval("estado") %>
                                               </span>
                                            </div>
                                        </div>
