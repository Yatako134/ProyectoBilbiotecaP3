...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="tabla-footer p-3 bg-light">
            <div class="pagination-container">
                ...
                <!-- ESPACIO PARA LA PAGINACIÓN DEL GRIDVIEW -->
                <div class="gridview-pager-wrapper">
                    <!-- La paginación del GridView aparecerá aquí automáticamente -->
                </div>
            </div>
        </div>
    </div>

    <!-- === SCRIPT PARA MOVER LA PAGINACIÓN === -->
    <script>
        function movePagination() {
            const pager = document.querySelector('.gridview-pager');
            const pagerWrapper = document.querySelector('.gridview-pager-wrapper');
            
            if (pager && pagerWrapper) {
        ...
        // También ejecutar después de postbacks (para ASP.NET Web Forms)
